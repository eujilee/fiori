		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Connection",
									"targetURL": "#syncproject1902-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncproject1902-display": {
								"semanticObject": "syncproject1902",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.project1902",
									"url": sap.ui.require.toUrl("sync/project1902")
								}
							}
						}
					}
